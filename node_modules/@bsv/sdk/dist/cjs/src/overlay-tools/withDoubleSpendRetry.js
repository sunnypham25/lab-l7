...
exports.withDoubleSpendRetry = withDoubleSpendRetry;
        ...
        try {
            ...
            if (attempts < maxRetries && error.name === 'WERR_REVIEW_ACTIONS') {
                ...
                if (doubleSpendResult?.competingBeef != null &&
                    ...
                    const competingTx = Transaction_js_1.default.fromBEEF(doubleSpendResult.competingBeef, doubleSpendResult.competingTxs[0]);
