...
class PushDrop {
    ...
    static decode(script) {
        const lockingPublicKey = index_js_2.PublicKey.fromString(index_js_2.Utils.toHex((0, utils_js_1.verifyNotNull)(script.chunks[0].data, 'script.chunks[0].data must have value')));
        const fields = [];
